...
func (api *ConsensusAPI) NewPayloadQng(params engine.ExecutableData, versionedHashes []common.Hash, beaconRoot *common.Hash, requests [][]byte, witness bool) (engine.PayloadStatusV1, error) {
	...
	block, err := engine.ExecutableDataToBlockQng(params, versionedHashes, beaconRoot, requests)
	if err != nil {
		bgu := "nil"
